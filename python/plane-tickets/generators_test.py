...
class PlaneTicketsTest(unittest.TestCase):
    ...
    def test_task1_returns_generator(self):
        ...
        error_message = (
            ...
            f"The function returned a {
                type(generate_seat_letters(number))} type, "
    ...
    def test_task2_returns_generator(self):
        ...
        error_message = (
            ...
            f"The function returned a {
                type(generate_seats(number))} type, "
            f"but the tests expected the function to return a <class 'generator'> type."
        )

        self.assertTrue(inspect.isgenerator(
            generate_seats(number)), msg=error_message)
    ...
    def test_task4_returns_generator(self):
        ...
        error_message = (
            ...
            f"The function returned a {
                type(generate_codes(seat_numbers, flight_id))} type, "
            f"but the tests expected the function to return a <class 'generator'> type."
        )
