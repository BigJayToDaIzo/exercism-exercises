...
class CardGamesTest(unittest.TestCase):
            ...
            with self.subTest(
                ...
                error_message = (
                    ...
                    f'The function returned {
                        actual_result}, but round {round_number} '
    ...
    def test_average_even_is_average_odd(self):
        input_data = [[5, 6, 8], [1, 2, 3, 4], [
            1, 2, 3], [5, 6, 7], [1, 3, 5, 7, 9]]
    ...
    def test_maybe_double_last(self):
        input_data = [(1, 2, 11), (5, 9, 11),
                      (5, 9, 10), (1, 2, 3), (1, 11, 8)]
        result_data = [[1, 2, 22], [5, 9, 22],
                       [5, 9, 10], [1, 2, 3], [1, 11, 8]]
        ...
        for variant, (hand, expected) in enumerate(
            ...
            with self.subTest(
                ...
                error_message = (
                    ...
                    f"The function returned {actual_result}, but "
                    f"the tests expected {
                        expected} as the maybe-doubled version of {list(hand)}."
                )
